...
type WatchVulnAppConfig struct {
	...
	OnceMode        bool                `yaml:"once" json:"once"`
	...
	MdDir           string              `yaml:"md_dir" json:"md_dir"`
	NoPush          bool                `yaml:"no_push" json:"no_push"`
...
func (c *WatchVulnAppConfig) GetPusher() (push.TextPusher, push.RawPusher, error) {
	...
	if len(textPusher) == 0 && len(rawPusher) == 0 && !c.NoPush {
		msg := `
