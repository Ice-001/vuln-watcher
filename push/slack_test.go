...
### **参考链接**
1. [https://github.com/vuln-watcher/issues/127](https://github.com/vuln-watcher/issues/127)
...
1. [https://github.com/search?q=watchvuln&ref=opensearch&type=repositories](https://github.com/search?q=watchvuln&ref=opensearch&type=repositories)`
	...
	assert.Contains(t, converted, "<https://github.com/vuln-watcher/issues/127|链接>")
